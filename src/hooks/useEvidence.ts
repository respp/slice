...
export function useEvidence(disputeId: string, role: EvidenceRole) {
    ...
    const partyInfo = {
        name: isClaimant ? (dispute?.claimer || "Julio Banegas") : (dispute?.defender || "Micaela Descotte"),
        role: isClaimant ? "Claimant" : "Defendant",
        avatar: isClaimant ? "/images/profiles-mockup/profile-1.png" : "/images/profiles-mockup/profile-2.png", // Mock or dynamic
    };
    ...
    const carouselImages = [
        { id: "c1", url: "/images/category-amount/evidencia-1.png", description: "Exhibit A" },
        { id: "c2", url: "/images/category-amount/evidencia-2.png", description: "Exhibit B" },
    ];
